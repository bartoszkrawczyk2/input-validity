...
<img src="https://badgen.net/static/npm%20package/0.1.5/green" style="height:20px" />
...
Minimal [(702 B min+gzip)](https://bundlephobia.com/package/input-validity@0.1.5) client-side form validation library with 0 dependencies that uses [native HTML5 validation](https://developer.mozilla.org/en-US/docs/Web/HTML/Constraint_validation). Works perfect with server-rendered apps and minimal frontend libraries such as [HTMX](https://htmx.org/) or [Alpine.js](https://alpinejs.dev/).
